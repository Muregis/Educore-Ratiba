...
<div class="card">
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 10px;">
        ...
        <div style="display: flex; gap: 8px;">
            <a href="/fet-timetable/admin/export_csv.php?entity=subjects&search=<?php echo htmlspecialchars($search); ?>&class_id=<?php echo $classFilter; ?>&format=csv" class="btn btn-secondary" style="padding: 10px 16px;">Export CSV</a>
            <a href="/fet-timetable/admin/export_csv.php?entity=subjects&search=<?php echo htmlspecialchars($search); ?>&class_id=<?php echo $classFilter; ?>&format=xlsx" class="btn btn-secondary" style="padding: 10px 16px;">Export Excel</a>
        </div>
    </div>
